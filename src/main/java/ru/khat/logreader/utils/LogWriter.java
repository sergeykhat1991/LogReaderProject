...
public class LogWriter implements Runnable {
    ...
    public LogWriter(String searchIn, String input, List<PairOfDatesXMLGrCal> pairOfDatesPeriods, String name, String outputFormat) {
    ...
    private void convertToLOG(String filepath, List<Block> resultList) {
        ...
        try {
            try (FileWriter fileWriter = new FileWriter(new File(filepath + ".log"))) {
